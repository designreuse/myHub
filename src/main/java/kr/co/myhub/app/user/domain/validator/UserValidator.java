...
public class UserValidator extends MyHubValidator implements Validator {
    ...
    /* Constructors */
    public UserValidator(TypeEnum type) {
        this.type = type;
    }
    ...
    public void validate(Object target, Errors errors) {
        ...
        if (type == TypeEnum.CREATE) {
            MyHubValidator.rejectIfEmpty(errors, "email", "myhub.label.input.email.address");
            MyHubValidator.rejectIsEmail(errors, "email", "myhub.label.input.vaild.email.address");
            MyHubValidator.rejectIfEmpty(errors, "userId", "myhub.label.input.id");
            MyHubValidator.rejectIfEmpty(errors, "password", "myhub.label.input.password");
            MyHubValidator.rejectIfEmpty(errors, "userName", "myhub.label.input.name");
            MyHubValidator.rejectIfEmpty(errors, "birthday", "myhub.label.input.birthdy");
            MyHubValidator.rejectNotEqualslength(errors, "birthday", "myhub.label.input.birthdy.length", 8);
            MyHubValidator.rejectIfEmpty(errors, "gender", "myhub.label.select.gender");
